...
Aquaplane.Preloader.prototype = {
    ...
    preload: function () {
        ...
        this.load.images([ 'logo', 'dog', 'pole', 'rock', 'shark', 'sea' ]);
        ...
        this.load.spritesheet('town', 'town1.png', 700, 600);
        this.load.spritesheet('zombie', 'zombie.png', 96, 96);
        this.load.spritesheet('zombkabob', 'zombkabob.png', 96, 96);
...
Aquaplane.MainMenu.prototype = {
    ...
    create: function () {
        ...
        var town = this.add.sprite(0, 0, 'town', this.game.width);
...
Aquaplane.Game.prototype = {
    ...
    create: function () {
        ...
        this.skier = this.layer.create(0, 0, 'man');
